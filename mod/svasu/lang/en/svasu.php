...
/**
 * Strings for component 'svasu', language 'en'
 *
 * @package   mod_svasu
...
$string['activityoverview'] = 'You have SVASU packages that need attention';
...
$string['autocommit_help'] = 'If enabled, SVASU data is automaticaly saved to the database. Useful for SVASU objects which do not save their data regularly.';
$string['autocommitdesc'] = 'Automatically save SVASU data if the SVASU package does not save it.';
...
$string['badimsmanifestlocation'] = 'An imsmanifest.xml file was found but it was not in the root of your zip file, please re-package your SVASU';
...
$string['completionscorerequired_help'] = 'Enabling this setting will require a user to have at least the minimum score entered to be marked complete in this SVASU activity, as well as any other Activity Completion requirements.';
...
$string['completionstatusallscos_help'] = 'Some SVASU packages contain multiple components or "scos" - when this is enabled all scos within the package must return the relevant lesson_status for this activity to be flagged complete.';
...
$string['completionstatusrequired_help'] = 'Checking one or more statuses will require a user to achieve at least one of the checked statuses in order to be marked complete in this SVASU activity, as well as any other Activity Completion requirements.';
...
$string['crontask'] = 'Background processing for SVASU';
...
$string['deleteallattempts'] = 'Delete all SVASU attempts';
...
$string['displayactivityname_help'] = 'Whether or not to display the activity name above the SVASU player.';
$string['displayattemptstatus'] = 'Display attempt status';
$string['displayattemptstatus_help'] = 'This preference allows a summary of the users attempts to show in the course overview block in Dashboard and/or the SVASU entry page.';
$string['displayattemptstatusdesc'] = 'Whether a summary of the user\'s attempts is shown in the course overview block in Dashboard and/or the SVASU entry page.';
$string['displaycoursestructure'] = 'Display course structure on entry page';
$string['displaycoursestructure_help'] = 'If enabled, the table of contents is displayed on the SVASU outline page.';
$string['displaycoursestructuredesc'] = 'If enabled, the table of contents is displayed on the SVASU outline page.';
$string['displaydesc'] = 'Whether to display the SVASU package in a new window.';
$string['displaysettings'] = 'Display settings';
$string['dnduploadsvasu'] = 'Add a SVASU package';
...
$string['eventscorerawsubmitted'] = 'Submitted SVASU raw score';
$string['eventstatussubmitted'] = 'Submitted SVASU status';
...
$string['finishsvasu'] = 'If you have finished viewing this resource, {$a}';
$string['finishsvasulinkname'] = 'click here to return to the course page';
$string['firstaccess'] = 'First access';
$string['firstattempt'] = 'First attempt';
$string['floating'] = 'Floating';
$string['forcecompleted'] = 'Force completed';
$string['forcecompleted_help'] = 'If enabled, the status of the current attempt is forced to "completed". (Only applicable to SVASU 1.2 packages.)';
...
* When previous attempt completed, passed or failed - This relies on the SVASU package setting the status of \'completed\', \'passed\' or \'failed\'.
* Always - Each re-entry to the SVASU activity will generate a new attempt and the student will not be returned to the same point they reached in their previous attempt.';
...
$string['forcejavascript_desc'] = 'If enabled (recommended) this prevents access to SVASU objects when JavaScript is not supported/enabled in a users browser. If disabled the user may view the SVASU but API communication will fail and no grade information will be saved.';
...
$string['hidetoc_help'] = 'How the table of contents is displayed in the SVASU player';
$string['hidetocdesc'] = 'This setting specifies how the table of contents is displayed in the SVASU player.';
...
$string['indicator:cognitivedepth'] = 'SVASU cognitive';
$string['indicator:cognitivedepth_help'] = 'This indicator is based on the cognitive depth reached by the student in a SVASU activity.';
$string['indicator:cognitivedepthdef'] = 'SVASU cognitive';
$string['indicator:cognitivedepthdef_help'] = 'The participant has reached this percentage of the cognitive engagement offered by the SVASU activities during this analysis interval (Levels = No view, View, Submit, View feedback)';
$string['indicator:cognitivedepthdef_link'] = 'Learning_analytics_indicators#Cognitive_depth';
$string['indicator:socialbreadth'] = 'SVASU social';
$string['indicator:socialbreadth_help'] = 'This indicator is based on the social breadth reached by the student in a SVASU activity.';
$string['indicator:socialbreadthdef'] = 'SVASU social';
$string['indicator:socialbreadthdef_help'] = 'The participant has reached this percentage of the social engagement offered by the SVASU activities during this analysis interval (Levels = No participation, Participant alone)';
$string['indicator:socialbreadthdef_link'] = 'Learning_analytics_indicators#Social_breadth';
$string['info'] = 'Info';
$string['interactions'] = 'Interactions';
$string['masteryoverride'] = 'Mastery score overrides status';
$string['masteryoverride_help'] = 'If enabled and a mastery score is provided, when LMSFinish is called and a raw score has been set, status will be recalculated using the raw score and mastery score and any status provided by the SVASU (including "incomplete") will be overridden.';
...
$string['trackid'] = 'ID';
$string['trackid_help'] = 'This is the identifier set by your SVASU package for this question, the SVASU specification doesn\'t allow the full question text to be provided.';
...
$string['invalidactivity'] = 'SVASU activity is incorrect';
...
$string['lastattemptlock_help'] = 'If enabled, a student is prevented from launching the SVASU player after using up all their allocated attempts.';
$string['lastattemptlockdesc'] = 'If enabled, a student is prevented from launching the SVASU player after using up all their allocated attempts.';
$string['location'] = 'Show the location bar';
$string['max'] = 'Max score';
$string['maximumattempts'] = 'Number of attempts';
$string['maximumattempts_help'] = 'This setting enables the number of attempts to be restricted. It is only applicable for SVASU 1.2 and AICC packages.';
...
$string['mode'] = 'Mode';
$string['modulename'] = 'Svasu';
$string['modulename_help'] = 'Transform your Knowledge, PPT, PDF, Video into Digital Learning (SVASU Scorm). It is a simple to use platform to transform your knowledge into Digital Learning.Instantly Convert Your PowerPoint / PDF / Video Training to Interactive Course';
$string['modulename_link'] = 'mod/hotquestion/view';
$string['modulenameplural'] = 'Svasu';
...
* Under content - Navigation buttons are shown below the SVASU package content
...
$string['networkdropped'] = 'The SVASU player has determined that your Internet connection is unreliable or has been interrupted. If you continue in this SVASU activity, your progress may not be saved.<br />
...
$string['noscriptnosvasu'] = 'Your browser does not support JavaScript or it has JavaScript support disabled. This SVASU package may not play or save data correctly.';
...
$string['page-mod-svasu-x'] = 'Any SVASU module page';
$string['pagesize'] = 'Page size';
$string['package'] = 'Package file';
$string['package_help'] = 'The package file is a zip (or pif) file containing SVASU/AICC course definition files.';
...
$string['packageurl_help'] = 'This setting enables a URL for the SVASU package to be specified, rather than choosing a file via the file picker.';
$string['passed'] = 'Passed';
$string['php5'] = 'PHP 5 (DOMXML native library)';
$string['pluginadministration'] = 'SVASU package administration';
$string['pluginname'] = 'SVASU package';
$string['popup'] = 'New window';
$string['popuplaunched'] = 'This SVASU package has been launched in a popup window, If you have finished viewing this resource, click here to return to the course page';
$string['popupmenu'] = 'In a drop-down menu';
$string['popupopen'] = 'Open package in a new window';
$string['popupsblocked'] = 'It appears that popup windows are blocked, stopping this SVASU package from playing. Please check your browser settings before trying again.';
...
$string['privacy:metadata:aicc:data'] = 'Personal data passed through from the AICC/SVASU subsystem.';
...
$string['privacy:metadata:aicc_session:svasumode'] = 'The mode of the element to be tracked';
$string['privacy:metadata:aicc_session:svasustatus'] = 'The status of the element to be tracked';
...
$string['privacy:metadata:svasu_aicc_session'] = 'The session information of the AICC HACP';
$string['privacy:metadata:svasu_scoes_track'] = 'The tracked data of the SCOes belonging to the activity';
$string['privacy:metadata:timemodified'] = 'The time when the tracked element was last modified';
$string['privacy:metadata:userid'] = 'The ID of the user who accessed the SVASU activity';
$string['protectpackagedownloads'] = 'Protect package downloads';
$string['protectpackagedownloads_desc'] = 'If enabled, SVASU packages can be downloaded only if the user has the course:manageactivities capability. If disabled, SVASU packages can always be downloaded (by mobile or other means).';
...
$string['svasustandard'] = 'SVASU standards mode';
$string['svasustandarddesc'] = 'When disabled, Moodle allows SVASU 1.2 packages to store more than the specification allows, and uses Moodle full name format settings when passing the users name to the SVASU package.';
$string['scoes'] = 'Learning objects';
$string['score'] = 'Score';
$string['svasu:addinstance'] = 'Add a new SVASU package';
$string['svasuclose'] = 'Available to';
$string['svasucourse'] = 'Learning course';
$string['svasu:deleteresponses'] = 'Delete SVASU attempts';
$string['svasuloggingoff'] = 'API logging is off';
$string['svasuloggingon'] = 'API logging is on';
$string['svasuopen'] = 'Available from';
$string['svasuresponsedeleted'] = 'Deleted user attempts';
$string['svasu:deleteownresponses'] = 'Delete own attempts';
$string['svasu:savetrack'] = 'Save tracks';
$string['svasu:skipview'] = 'Skip overview';
$string['svasutype'] = 'Type';
$string['svasutype_help'] = 'This setting determines how the package is included in the course. There are up to 4 options:

* Uploaded package - Enables a SVASU package to be chosen via the file picker
* External SVASU manifest - Enables an imsmanifest.xml URL to be specified. Note: If the URL has a different domain name than your site, then "Downloaded package" is a better option, since otherwise grades are not saved.
* Downloaded package - Enables a package URL to be specified. The package will be unzipped and saved locally, and updated when the external SVASU package is updated.
* External AICC URL - this URL is the launch URL for a single AICC Activity.  A psuedo package will be constructed around this.';
$string['svasu:viewreport'] = 'View reports';
$string['svasu:viewscores'] = 'View scores';
$string['scrollbars'] = 'Allow the window to be scrolled';
$string['search:activity'] = 'SVASU package - activity information';
...
$string['subplugintype_svasureport'] = 'Report';
$string['subplugintype_svasureport_plural'] = 'Reports';
...
$string['typeexternal'] = 'External SVASU manifest';
...
$string['validateasvasu'] = 'Validate a package';
$string['validation'] = 'Validation result';
$string['validationtype'] = 'This preference set the DOMXML library used for validating SVASU Manifest. If you don\'t know leave the selected choice.';
$string['value'] = 'Value';
...
* Some SVASU packages are intelligent about new attempts, many are not. What this means is that if the learner re-enters an existing attempt, if the SVASU content does not have internal logic to avoid overwriting previous attempts they can be overwritten, even though the attempt was \'completed\' or \'passed\'.
