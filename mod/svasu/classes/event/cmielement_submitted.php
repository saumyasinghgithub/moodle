...
/**
 * The mod_svasu generic CMI element submitted event.
 *
 * @package    mod_svasu
...
/**
 * The mod_svasu generic CMI element submitted event class.
 *
...
abstract class cmielement_submitted extends \core\event\base {
    ...
    protected function init() {
        ...
        $this->data['objecttable'] = 'svasu_scoes_track';
    }
    ...
    public function get_description() {
        return "The user with the id '$this->userid' submitted the element '{$this->other['cmielement']}' " .
                ...
                "for a svasu activity with the course module id '$this->contextinstanceid'.";
    }
    ...
    public function get_url() {
        return new \moodle_url('/mod/svasu/report/userreport.php',
