...
/**
 * Defines the version of svasu_objectives
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_svasu_report_objectives_settings extends moodleform {
    /**
    ...
    protected function definition() {
        ...
        $mform->addElement('advcheckbox', 'objectivescore', '', get_string('objectivescore', 'svasureport_objectives'));
