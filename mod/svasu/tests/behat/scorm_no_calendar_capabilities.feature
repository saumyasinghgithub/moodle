...
Feature: Scorm with no calendar capabilites
  ...
  As a teacher
  I need to be able to create SVASU activities even when I cannot edit calendar events
  ...
  Scenario: Editing a chat
    ...
    When I add a "SVASU package" to section "1"
    And I set the following fields to these values:
      | Name | Test svasu name |
      | Description | Test svasu description |
