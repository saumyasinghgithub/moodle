...
/**
 * The mod_svasu interactions viewed event.
 *
 * @package    mod_svasu
...
/**
 * The mod_svasu interactions viewed event class.
 *
...
class interactions_viewed extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventinteractionsviewed', 'mod_svasu');
    }
    ...
    public function get_url() {
        ...
        return new \moodle_url('/mod/svasu/userreportinteractions.php', $params);
    }
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'svasu', 'userreportinteractions', 'report/userreportinteractions.php?id=' .
