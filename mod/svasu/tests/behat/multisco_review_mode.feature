...
Feature: Scorm multi-sco review mode.
  ...
  Scenario: Test review mode with a single sco completion.
    ...
    And I should see "Basic Multi-sco SVASU package"
    And I log out
  ...
  Scenario: Test review mode with all scos completed.
    ...
    And I upload "mod/svasu/tests/packages/RuntimeMinimumCalls_SVASU12.zip" file to "Package file" filemanager
    And I click on "Save and display" "button"
    And I should see "ADV Multi-sco SVASU package"
    And I log out
    And I log in as "student1"
    And I am on "Course 1" course homepage
  ...
  Scenario: Test force completed set to Always.
    ...
    And I upload "mod/svasu/tests/packages/RuntimeMinimumCalls_SVASU12-mini.zip" file to "Package file" filemanager
    And I click on "Save and display" "button"
    And I should see "Basic Multi-sco SVASU package"
    And I log out
    And I log in as "student1"
