...
/**
 * The mod_svasu tracks viewed event.
 *
 * @package    mod_svasu
...
/**
 * The mod_svasu tracks viewed event class.
 *
 * @property-read array $other {
 *      Extra information about event properties.
 *
 *      - int attemptid: Attempt id.
 *      - int instanceid: Instance id of the svasu activity.
...
class tracks_viewed extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '$this->userid' viewed the tracks for the user with id '$this->relateduserid' " .
            "for the svasu activity with course module id '$this->contextinstanceid'.";
    }
    ...
    public static function get_name() {
        return get_string('eventtracksviewed', 'mod_svasu');
    }
    ...
    public function get_url() {
        ...
        return new \moodle_url('/mod/svasu/userreporttracks.php', $params);
    }
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'svasu', 'userreporttracks', 'report/userreporttracks.php?id=' . $this->contextinstanceid
    ...
    public static function get_other_mapping() {
        ...
        $othermapped['scoid'] = array('db' => 'svasu_scoes', 'restore' => 'svasu_scoe');
