...
//
function AICCapi(def, cmiobj, svasuauto, cfgwwwroot, svasuid, scoid, attempt, viewmode, currentorg, sesskey, cmid, autocommit) {
...
M.svasu_api.init = function(Y, def, cmiobj, svasuauto, cfgwwwroot, svasuid, scoid, attempt, viewmode, currentorg, sesskey, cmid, autocommit) {
    window.API = new AICCapi(def, cmiobj, svasuauto, cfgwwwroot, svasuid, scoid, attempt, viewmode, currentorg, sesskey, cmid, autocommit);
}
