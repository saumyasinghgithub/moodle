...
class provider implements
    ...
    public static function get_metadata(collection $collection) : collection {
        $collection->add_database_table('svasu_scoes_track', [
            ...
            ], 'privacy:metadata:svasu_scoes_track');

        $collection->add_database_table('svasu_aicc_session', [
                'userid' => 'privacy:metadata:userid',
                'svasumode' => 'privacy:metadata:aicc_session:svasumode',
                'svasustatus' => 'privacy:metadata:aicc_session:svasustatus',
                'attempt' => 'privacy:metadata:attempt',
                ...
                'timemodified' => 'privacy:metadata:timemodified',
            ], 'privacy:metadata:svasu_aicc_session');
    ...
    public static function get_contexts_for_userid(int $userid) : contextlist {
        ...
        $contextlist->add_from_sql(sprintf($sql, 'svasu_scoes_track'), $params);
        $contextlist->add_from_sql(sprintf($sql, 'svasu_aicc_session'), $params);
    ...
    public static function get_users_in_context(userlist $userlist) {
        ...
        $userlist->add_from_sql('userid', sprintf($sql, 'svasu_scoes_track'), $params);
        $userlist->add_from_sql('userid', sprintf($sql, 'svasu_aicc_session'), $params);
    }
    ...
    public static function export_user_data(approved_contextlist $contextlist) {
        ...
        // The scoes_track data is organised in: {Course name}/{SVASU activity name}/{My attempts}/{Attempt X}/data.json
        ...
        array_walk($alldata, function($attemptsdata, $contextid) {
            ...
            array_walk($attemptsdata, function($data, $attempt) use ($context) {
                $subcontext = [
                    ...
                    get_string('attempt', 'svasu'). " $attempt"
                ];
        ...
        foreach ($aiccsessions as $aiccsession) {
            $alldata[$aiccsession->contextid][] = (object)[
                    'svasumode' => $aiccsession->svasumode,
                    'svasustatus' => $aiccsession->svasustatus,
        ...
        // The aicc_session data is organised in: {Course name}/{SVASU activity name}/{My AICC sessions}/data.json
    ...
    public static function delete_data_for_all_users_in_context(\context $context) {
        ...
        static::delete_data('svasu_scoes_track', $sql, $params);
        static::delete_data('svasu_aicc_session', $sql, $params);
    }
