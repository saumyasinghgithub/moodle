...
/**
 * The mod_svasu raw score submitted event.
 *
 * @package    mod_svasu
...
/**
 * The mod_svasu raw score submitted event class.
 *
...
class scoreraw_submitted extends cmielement_submitted {
    ...
    public static function get_name() {
        return get_string('eventscorerawsubmitted', 'mod_svasu');
    }
    ...
    protected function validate_data() {
        ...
        // Note: we trust that 'cmivalue' represents a valid SVASU CMI score value.
    }
}
